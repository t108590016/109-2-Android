...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateNotification() {
        ...
        notifyBuilder.setStyle(new NotificationCompat.InboxStyle().setSummaryText("Update notification!").addLine("Second line.").setBigContentTitle(getString(R.string.notification_updated)));
