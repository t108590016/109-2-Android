...
public class CustomReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String randomNumber = intent.getStringExtra("Extra Data");
        if (intentAction != null) {
            ...
            switch (intentAction){
                ...
                case ACTION_CUSTOM_BROADCAST:
                    toastMessage =
                            context.getString(R.string.custom_broadcast_toast) + "\nSquare of the random number: " + String.valueOf(Integer.parseInt(randomNumber) * Integer.parseInt(randomNumber));
                    break;
            }
